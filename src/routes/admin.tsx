...
import { LayoutDashboard, Package, Tags, ShoppingBag, Users, FileText, CreditCard, Home, Rocket, Ticket, Gift, Settings, Menu } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/menus", label: "Menus (5)", icon: Menu },
