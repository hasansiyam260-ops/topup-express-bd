...
-- Roles enum + table (separate from profiles, prevents privilege escalation)
...
CREATE TABLE public.products (
  ...
  pack_type TEXT NOT NULL DEFAULT 'diamond',
  name_en TEXT NOT NULL,
  name_bn TEXT,
  image_url TEXT,
  price NUMERIC NOT NULL,
  original_price NUMERIC,
  server TEXT NOT NULL DEFAULT 'BD',
  badge TEXT,
...
CREATE TABLE public.orders (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  order_number TEXT NOT NULL UNIQUE DEFAULT ('UID' || to_char(now(),'YYMMDD') || lpad(floor(random()*100000)::text,5,'0')),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
